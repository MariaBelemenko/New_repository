...
/**
 * Created by u4400015 on 06/06/2016.
 */
public class CommonSearchResultsListTest extends BaseStepDef {
    ...
    public void theUserClicksThroughTheTabLinksThatAreDisplayedOnTheHomePage(String subMenuLink, java.util.List<String> links) throws Throwable {
        String pageTitle = "";
        String linkToClick = "";
        String headerToFind = "";
        ...
        java.util.List<String> linksRetrieved = homePage.getLinksInHomepageMainMenu();
