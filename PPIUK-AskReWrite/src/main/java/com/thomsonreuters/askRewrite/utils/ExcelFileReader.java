//package com.thomsonreuters.askRewrite.utils;
//
...
//    private final static String ASK_USERS_XLSX = System.getProperty("ask.rewrite.users.xls.path");
...
//        FileLock fileLock;
//        int counter = 0;
//        raf = new RandomAccessFile(ASK_USERS_XLSX, "rw");
...
//    }
//
//    public static String getAskReWriteEmail(String username) {
//        loadDataIntoMAP();
//        try {
...
//    }
//
//    public static String getAskReWritePassword(String username) {
//        loadDataIntoMAP();
//        try {
...
//        try {
//            FileInputStream file = new FileInputStream(ASK_USERS_XLSX);
...
//        return getDataFromAskReWriteUSers(EMAILS_SHEET_NAME, email, EMAILS_PASSWORD_COLUMN_NUMBER);
//    }
//
//    private static String getDataFromAskReWriteUSers(String sheetName, String firstColumnValue, int columnNumber) {
//        for (int i = 0; i < 5; i++) {
//            try {
