...
public class ExportFolderPopup extends AbstractPage{
	...
	public boolean isFolderVisible(String folderName) {
		return isElementPresent(By.xpath("//*[@class='co_deliveryFolderExport_tree']//a[contains(text(),'"+folderName+" (')]"));
	}

	public WebElement checkBox(String folderName) {
		return waitForExpectedElement(By.xpath("//*[@class='co_deliveryFolderExport_tree']//a[contains(text(),'"+folderName+" (')]/ancestor::div/input"));
	}
