...
public class DocumentNavigationPage extends DocumentDisplayAbstractPage {
    ...
    public boolean isRightCarosalLinkAvailable() {
        try {
            return getRightCarosalLink().isDisplayed();
        } catch (PageOperationException pe) {
            logger.warn("context", pe);
        }
        return false;
    }
    ...
    public boolean isLeftCarosalLinkAvailable() {
        try {
            return getLeftCarosalLink().isDisplayed();
        } catch (PageOperationException pe) {
            LOG.info("context", pe);
        }
        return false;
    ...
    public boolean isPreviousResultLinkPresentOnResultsNavigationWidget() {
        try {
            return getPreviousResultLink().isDisplayed();
        } catch (PageOperationException pe) {
            LOG.info("context", pe);
        }
        return false;
     ...
     * @return WebElement
     */
    private WebElement getPreviousResultLink() {
        try {
    ...
    public boolean isNextResultLinkPresentOnResultsNavigationWidget() {
        try {
            return getNextResultLink().isDisplayed();
        } catch (PageOperationException pe) {
            LOG.info("context", pe);
        }
        return false;
     ...
     * @return WebElement
     */
    private WebElement getNextResultLink() {
        try {
    ...
    public boolean isBackToResultsLinkPresentOnResultsNavigationWidget() {
        try {
            return waitFluentForElement(BACK_TO_RESULTS_LINK_LOCATOR).isDisplayed();
    ...
    public boolean isPrimaryMenuPresent(String primaryLink) {
        if (org.springframework.util.StringUtils.isEmpty(primaryLink)) {
            throw new IllegalArgumentException(" Primary link name is required.");
        }
        try {
            return waitForElementPresent(DocumentPrimaryLink.getLink(primaryLink).getCssLocator()).isDisplayed();
        } catch (TimeoutException te) {
            LOG.info("context", te);
        }
        return false;
