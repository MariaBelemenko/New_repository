...
public class InsertEditLink extends TinyMceEditor {
    ...
    public boolean isTitleFieldDisplayed() {
        try {
            return findElement(By.xpath("//div[contains(@class,'mce-window mce-in')]//label[text()='Title']")).isDisplayed();
    ...
    public boolean isTargetFieldDisplayed() {
        try {
            return findElement(By.xpath("//div[contains(@class,'mce-window mce-in')]//label[text()='Target']")).isDisplayed();
        } catch (NoSuchElementException te) {
            return false;
        }
    }
    ...
    public boolean isTextFieldDisplayed() {
        try {
            return waitForExpectedElement(By.xpath("//div[contains(@class,'mce-window mce-in')]//label[text()='Text to display']")).isDisplayed();
        } catch (TimeoutException te) {
    ...
    public boolean isUrlFieldDisplayed() {
        try {
            return waitForExpectedElement(By.xpath("//div[contains(@class,'mce-window mce-in')]//label[text()='Url']")).isDisplayed();
        } catch (TimeoutException te) {
            return false;
        }
    }
    ...
    public boolean isOKButtonDisplayed() {
        try {
            return waitForExpectedElement(By.xpath("//div[contains(@class,'mce-window mce-in')]//button[text()='Ok']")).isDisplayed();
        } catch (TimeoutException te) {
            return false;
        }
    }
    ...
    public boolean isCancelButtonDisplayed() {
        try {
            return waitForExpectedElement(By.xpath("//div[contains(@class,'mce-window mce-in')]//button[text()='Cancel']")).isDisplayed();
        } catch (TimeoutException te) {
            return false;
        }
    }
