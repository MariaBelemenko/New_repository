...
public class AskResourcePage extends CommonResourcePage {
    ...
    public int numberOfComments() {
        return waitForExpectedElements(By.cssSelector("#co_docContentBody .askCommentResponse")).size();
    }
    ...
    public WebElement addReplyTextArea() {
        return waitForExpectedElement(By.cssSelector("div.commentFieldsContainer >textarea"));
    }
    ...
    public WebElement agreeToRulesCheckbox(){
        return waitForExpectedElement(By.cssSelector("div.commentActionContainer div:nth-of-type(3)>label>input"));
    }
