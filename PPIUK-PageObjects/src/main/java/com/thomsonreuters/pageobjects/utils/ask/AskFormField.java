...
public enum AskFormField implements FormField {
    ...
    ORGANISATION_TYPE("Organisation Type", By.id("OrganisationType"), DropDown.newInstance(), By.cssSelector("span[data-valmsg-for='Position']"), "Please enter your position"),
    ...
    JURISDICTION("Jurisdiction", By.id("Jurisdiction"), DropDown.newInstance(), By.cssSelector("span[data-valmsg-for='AnsweringService']"), "Please enter an answering service"),
