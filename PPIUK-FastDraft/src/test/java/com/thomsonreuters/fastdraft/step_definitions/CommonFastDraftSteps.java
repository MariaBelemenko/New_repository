...
public class CommonFastDraftSteps extends BaseStepDef {
    ...
    public void createFastDraftProject(String projectType, String documentType, String projectName, String documentName) throws Throwable {
        dashboardPage.waitForPageToLoad();
    ...
    public void deleteAllFastDraftProjects() throws Throwable {
        ...
        if (countProjects != 0) {
            for (int i = countProjects; i >= 1; i--) {
                dashboardPage.waitForPageToLoad();
                dashboardPage.checkFastDraftDashboardPresents();
                fastDraftUtils.deleteProject(i);
            }
        } else {
