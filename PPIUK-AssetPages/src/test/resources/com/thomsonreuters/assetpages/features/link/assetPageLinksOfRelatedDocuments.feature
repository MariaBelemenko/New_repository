@e2e @prod
Feature: As a PL+ User I want to view list of Related documents grouped by document type in case asset page

  Scenario Outline: The case asset page contain list of Related documents grouped by document type
    ...
    Examples:
      | GUID                              | link                                                               | type                       |
      | I984ef7396cf011e498db8b09b4f043e0 | Enforcing security: overview                                       | UK Practice Note Overviews | 
