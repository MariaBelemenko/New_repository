Feature: [811152] As a PL+ User I want to see Where Reported and Where Reported list in right hand side menu
  ...
  Scenario Outline: [811152] The case documents contain Where Reported list
  ...
  Scenario Outline: [811152] The case documents does not contain End of Document
    When the user opens document with <GUID> guid
    Then the document opens correctly
  ...
  Scenario Outline: [811152] The case documents contain Resource Type and Count
    When the user opens document with <GUID> guid
    Then the document opens correctly
    And the metadata is displayed in the right hand side of the central column
