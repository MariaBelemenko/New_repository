...
public class CommonAssetPageSteps extends BaseStepDef {
	...
	public void theUserSeeWhereReportedList() throws Throwable {
		assertTrue("The user doesn't see Where reported list", assetDocumentPage.whereReportedList().isDisplayed());
	}
	...
	public void theUserSeesLinkInTheSection(String linkText, String sectionName) throws Throwable {
		assertTrue("The user doesn't see link in section",
				assetDocumentPage.linkInLegalUpdatesSection(linkText, sectionName).isDisplayed());
	}
