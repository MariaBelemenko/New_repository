@e2e
Feature: As a PPI User I want to see a  Title, Content, Date/Time that I visited it and Client ID for every document in the Document view in the History page so I can go back to a document visited before.
  As a PPI User I want to see the content type  for every document in History so I can identify and organize my documents.
  As a PPI User I want to see Event, Description, Date/Time that I visit it and Client ID for every event in the All History view in the History page so I can go back to a event done/visited before.
