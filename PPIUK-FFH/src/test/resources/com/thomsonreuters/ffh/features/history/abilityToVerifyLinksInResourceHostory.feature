Feature: Ability to Verify Links in Resource History
  ...
  Scenario Outline: Verify Legal Update on Development Link in Resource History
    Given PL+ user 'FFHTestUser' navigates directly to document with guid '<GUID>'
  ...
  Examples:
    | Resource History Section            | GUID                              | title                                                  |
    | Further developments                | Id5a1824b18d111e498db8b09b4f043e0 | Q & A: Lock, Bear Scotland and other holiday pay cases |
    | What are the pensions implications? | Id5a1824b18d111e498db8b09b4f043e0 | Q & A: Lock, Bear Scotland and other holiday pay cases |