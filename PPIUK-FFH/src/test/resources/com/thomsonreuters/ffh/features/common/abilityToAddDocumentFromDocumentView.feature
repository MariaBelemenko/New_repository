@e2e @bug
Feature: As a PPI User When I am in a document I want to have the option to add it directly to my folders so I can access it later.
  As a PPI User I want to be able to delete a document from Folders so I can move it to Trash.
  As a PPI User I want to see the content type  for every document in my Folders so I can identify and organize my documents.
  As a PPI User I want to see a  Title, Resource Type and Date about the documents saved on Folders so I can identify the type of document.
  ...
  #Resource type was added for Know-how and Legal Updates documents only
  #822411 [REGRESSION] Resource type disappeared from Folders page
  Background:
  ...
  # 841527:REGRESSION - Ask documents inaccessible in QED due to network
  @bug
  ...
  Scenario Outline: Add glossary document to folder
