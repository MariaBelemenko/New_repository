Feature: As a PL+ User I want to view title, status, effective date and version
  As a PL+ User I want to see annotated statutes
  ...
  Scenario Outline: User can view the metadoc information for a case
    When the user opens document with <GUID> guid
    Then the user click on View Document button
    Then the document opens correctly
