Feature: Integration of TinyMce Editor
  ...
  Scenario: Character/Header Styles
  ...
  Scenario: Header Styles: HEADING/SUB_HEADING Styles
    Given PL+ user is logged in with following details
      | userName | librarian1 |
  ...
  Scenario Outline: Adding Annotaiton with Header Styles: HEADING/SUB_HEADING Applying to selected text
    Then the user has accessed annotations text box
    And highlighted text with the cursor
  ...
  Scenario: Inline Styles: BOLD/ITALIC/STRIKETHROUGH/ITALIC/SUPERSCRIPT/SUBSCRIPT/CODE
    Given PL+ user is logged in with following details
      | userName | librarian1 |
  ...
  Scenario: Alignment Styles: LEFT/CENTER/RIGHT/JUSTIFY
    Given PL+ user is logged in with following details
      | userName | librarian1 |
  ...
  Scenario Outline: Adding Annotaiton with Alignment Styles: LEFT/CENTER/RIGHT/JUSTIFY Applying to selected text
    When the user has accessed annotations text box
    And highlighted text with the cursor
