Feature: ukKnowHowFacetsFunctionality.feature - [713885] [702173] [710581] [728696] [702155] [702183] [702185] [702183] [702185] [702196] [715334]
  ...
  Scenario: [713885] Verify that when two or more facets are selected across facet groups then results are updated using the "and" operator
    ...
    When the user gets the know how facet "Glossary" count and stores it as count "1"
    And the user selects the know how parent facet "Employment"
    Then the user verifies that the know how facet is selected "Employment"
    ...
    Then the user verifies that the know how search result count "3" equals facet count "2"
  ...
  Scenario: [713885] Verify that when two or more facets are deselected then results are updated using the "and" operator
    ...
    Then the user verifies that the know how facet is selected "Checklists"
    When the user selects the know how option to apply filters
    ...
    Then the user verifies that the know how facet count "2" is less than "1"
    When the user deselects the know how facet "Glossary"
    Then the user verifies that the know how parent facet "Glossary" is not selected
    When the user deselects the know how facet "Corporate"
    Then the user verifies that the know how parent facet "Corporate" is not selected
    When the user selects the know how option to apply filters
    And the user gets the know how facet "Employment" count and stores it as count "2"
    And the user gets the know how search result count and stores it as count "3"
    Then the user verifies that the know how search result count "3" equals facet count "2"
  ...
  Scenario Outline: [710581] verify child facet not selected when parent is selected and that selecting a child deselects the parent
    And the user runs a free text search for the query "<query>"
    And the user is able to check whether the option to apply filters is displayed and  if not to ensure that it is
    Then the user verifies that know how "Practice Area" facet "<facet1>" is not selected
    When the user selects the know how parent facet "<facet1>"
    And the user selects the know how option to apply filters
    Then the user verifies that know how "Practice Area" facet "<facet2>" is not selected
    When the user selects the know how "Practice Area" facet "<facet2>"
    And the user selects the know how option to apply filters
    Then the user verifies that know how "Practice Area" facet "<facet1>" is not selected
  Examples:
    | query    | facet1       | facet2                 |
  ...
  Scenario: [no applicable story] verify that when the select multiple filter mode is cancelled facets are updated straight away
    And the user runs a free text search for the query "fishing"
    And the user gets the know how search result count and stores it as count "1"
    And the user is able to check whether the option to apply filters is displayed and  if not to ensure that it is
    ...
    When the user selects the know how parent facet "Family"
  ...
  Scenario:[728696] verify no know how facets with a count of 0 are displayed
    ...
    And the user is able to check whether the option to apply filters is displayed and  if not to ensure that it is
    Then the user verifies that the facet count for all the individual facets is not "0"
  ...
  Scenario: [702173] verify that child and grandchild practice area facets are listed in alphabetical order
    ...
    Then the user is able to verify the presence of the know how facet "Company Law"
    ...
    When the user expands the know how facet "Acquisitions"
    Then the user is able to verify the presence of the know how facet "Asset Acquisitions"
  ...
  Scenario:[702183] verify expansion of parent facet to display child and collapse of parent facet
    ...
    When the user expands the know how facet "Corporate"
    Then the user can verify the presence of a child topic entitled "Acquisitions"
    When the user collapses the know how facet "Corporate"
    Then the user can verify that the topic is no longer displayed "Acquisitions"
  ...
  Scenario: [702185] verify expansion and collapse of resource type facets showing and hiding sub resources
    ...
    When the user expands the know how facet "Standard Documents and Clauses"
    Then the user verifies the presence of the know how child facet "Standard clauses"
    When the user collapses the know how facet "Standard Documents and Clauses"
  ...
  Scenario Outline: [702196] verify "or" logic used between facets forming part of the same facet group - practice areas
    ...
    Then the user verifies the presence of the know how facet "<facet1>"
    And the user verifies the presence of an associated know how facet "<facet1>" count
    When the user gets the know how facet "<facet1>" count and stores it as count "1"
    ...
    When the user gets the know how facet "<facet2>" count and stores it as count "2"
    And the user selects the know how parent facet "<facet2>"
    And the user selects the know how option to apply filters
    Then the user verifies that the know how facet is selected "<facet2>"
    And the user gets the know how search result count and stores it as count "3"
    Then the user verifies that the know how search result count "3" exceeds facet count "1"
  ...
  Scenario Outline: [702196] Verify that when two facets are selected across facet groups then results are updated using the "and" operator
    ...
    Then the user verifies that the know how search result count "4" equals facet count "2"
    And the user verifies that the know how facet count "3" is less than "1"
