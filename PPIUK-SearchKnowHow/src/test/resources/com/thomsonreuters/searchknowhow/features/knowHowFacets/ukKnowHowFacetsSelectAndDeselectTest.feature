Feature: [714595][702169][702182][714594] ukKnowHowFacetsSelectAndDeselectTest.feature
  ...
  Scenario Outline: [714595] verify search results updated in light of parent facet selections. verify search results updated in light of parent and child facet selections. verify search results updated in light of child facet selections
    ...
    When the user gets the know how search result count and stores it as count "1"
    Then the user verifies that the know how parent facet "<facet1>" is not selected
    When the user expands the know how facet "<facet1>"
    Then the user verifies that the know how child facet "<facet2>" is not selected
    ...
    When the user selects the know how parent facet "<facet1>"
    And the user selects the know how option to apply filters
    Then the user verifies that the know how facet is selected "<facet1>"
    When the user selects the parent facet "<facet2>"
    And the user selects the know how option to apply filters
    Then the user verifies that the know how facet is selected "<facet2>"
    When the user gets the know how search result count and stores it as count "2"
    Then the user verifies that the know how search result count "2" is less than "1"
    When the user selects the know how child facet "<facet3>"
    And the user selects the know how option to apply filters
    And the user gets the know how search result count and stores it as count "3"
    Then the user verifies that the know how search result count "3" is less than "2"
  Examples:
  ...
  Scenario Outline: [714595] verify search results updated in light of child facet deselection and parent facet selection
    ...
    When the user expands the know how facet "<facet1>"
    Then the user verifies that the know how child facet "<facet2>" is not selected
    When the user expands the know how facet "<facet2>"
    Then the user verifies that the know how grandchild facet "<facet5>" is not selected
    And the user verifies that the know how parent facet "<facet1>" is not selected
    When the user expands the know how facet "<facet3>"
    Then the user verifies that the know how child facet "<facet4>" is not selected
    When the user selects the know how child facet "<facet2>"
    And the user selects the know how option to apply filters
    Then the user verifies that the know how facet is selected "<facet2>"
    When the user expands the know how facet "<facet3>"
    Then the user verifies that the know how child facet "<facet4>" is not selected
    When the user selects the know how child facet "<facet4>"
    And the user selects the know how option to apply filters
    ...
    And the user selects the know how option to apply filters
    Then the user verifies that the know how facet is selected "<facet1>"
    When the user selects the know how parent facet "<facet3>"
    And the user selects the know how option to apply filters
    Then the user verifies that the know how facet is selected "<facet3>"
  ...
  Scenario: [702169] Select facets and verify that number of results is reduced with each selection and that search results now tally with selected facets
    ...
    When the user gets the know how search result count and stores it as count "2"
    Then the user verifies that the know how search result count "2" is less than "1"
    When the user selects the know how parent facet "Corporate"
    And the user selects the option to apply filters
    Then the user verifies that the know how facet is selected "Corporate"
    When the user gets the know how search result count and stores it as count "3"
    Then the user verifies that the know how search result count "3" is less than "2"
    When the user selects the know how child facet "Private Equity and Venture Capital"
    And the user selects the option to apply filters
    Then the user verifies that the know how facet is selected "Private Equity and Venture Capital"
    When the user gets the know how search result count and stores it as count "4"
    Then the user verifies that the know how search result count "4" is less than "3"
    When the user selects the know how parent facet "Wales"
    And the user pauses for "2" seconds
    And the user selects the option to apply filters
    Then the user verifies that the know how facet is selected "Wales"
    When the user gets the know how search result count and stores it as count "5"
    Then the user verifies that the know how search result count "5" is less than "4"
    ...
    When the user opens the result in position "1"
    Then the user verifies that the product detail contains the practice area "PLC UK Pensions"
  ...
  Scenario: [702169] Deselect facets (parents and children) and verify that number of results is refreshed/increased with each deselection
    ...
    And the user selects the option to apply filters
    Then the user verifies that the know how facet is selected "Glossary"
    When the user selects the know how parent facet "Pensions"
    And the user selects the option to apply filters
    Then the user verifies that the know how facet is selected "Pensions"
    When the user gets the know how search result count and stores it as count "2"
    And the user deselects the know how facet "Pensions"
    And the user selects the option to apply filters
    And the user gets the know how search result count and stores it as count "3"
    Then the user verifies that the know how search result count "2" is less than "3"
    When the user deselects the know how facet "Glossary"
    And the user selects the option to apply filters
    And the user gets the know how search result count and stores it as count "4"
    Then the user verifies that the know how search result count "3" is less than "4"
  ...
  Scenario Outline: [714594] verify facets deselected by default. verify results updated in line with selected child facet. parent of selected child facet now selected - verify child deselected and results updated
    ...
    Then the user verifies that the know how child facet "<facet2>" is not selected
    When the user expands the know how facet "<facet2>"
    Then the user verifies that the know how grandchild facet "<facet3>" is not selected
    When the user selects the know how child facet "<facet2>"
    And the user selects the know how option to apply filters
    Then the user verifies that the know how facet is selected "<facet2>"
    When the user gets the know how search result count and stores it as count "2"
