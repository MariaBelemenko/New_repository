...
public class KnowHowDeliveryTest extends BaseStepDef {
    ...
    @And("^the user runs a free text search for the query \"(.*)\"$")
    ...
    public void theUserVerifiesThatTheResultsListPageIsDisplayed() throws Throwable {
        ...
        try {
            ...
            LOG.info("The user can not verify that the results list page is present", e);
        }
    }

    @And("^the user selects the checkbox associated with result \"([^\"]*)\"$")
    ...
    @Then("^the user downloads as (list_of_items|Documents) and verifies the processed message for successful downloads$")
    ...
    @And("^the user verifies the presence of an option entitled \"([^\"]*)\"$")
    ...
    @And("^the user verifies the presence of a font sub option \"([^\"]*)\"$")
    ...
    @And("^the user verifies the presence of a links sub option \"([^\"]*)\"$")
    ...
    public void theUserVerifiesThatTheOptionEntitledExpandedMarginForNotesIsNoLongerPresent() throws Throwable {
        ...
        try {
            ...
            LOG.info("The Expanded Margin for Notes is present", e);
        }
        assertFalse(isPresent);
    }

    @And("^the user selects the list of items format option \"([^\"]*)\"$")
    ...
    @And("^the user verifies the presence of an As option entitled \"([^\"]*)\"$")
    public void theUserVerifiesThePresenceOfAnAsOptionEntitled(String arg1) throws Throwable {
        searchResultsPage.asDropdownOption(arg1).isDisplayed();
    }

    @And("^the user enters \"([^\"]*)\" into the email To field$")
    ...
    @And("^the user enters \"([^\"]*)\" into the email Subject field$")
    ...
    @And("^the user enters \"([^\"]*)\" into the email note field$")
    ...
    @Then("^the user verifies the presence of the Print delivery request button$")
