...
public class SelectAndDeSelectFacetTest extends BaseStepDef {
    ...
    @And("^the user verifies that the know how child facet \"(.*?)\" is not selected$")
    ...
    @Then("^the user verifies that the know how grandchild facet \"(.*?)\" is not selected$")
    ...
    @And("^the user verifies that the know how child facet \"(.*?)\" has been deselected$")
    ...
    @And("^the user is able to verify that the search result in position \"(.*?)\" within the result list has the resource type \"(.*?)\"$")
    ...
    @And("^the user is able to verify that the search result in position \"(.*?)\" within the result list has the jurisdiction \"(.*?)\"$")
    ...
    @Then("^the user opens the result in position \"(.*?)\"$")
    ...
    @Then("^the user verifies that the product detail contains the practice area \"([^\"]*)\"$")
    ...
    @And("^the user is able to verify the (presence|absence) of the facet group heading Jurisdiction$")
    ...
    @And("^the user verifies that the know how grandchild facet \"(.*?)\" is not displayed$")
