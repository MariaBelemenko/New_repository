...
public class InternationalTransactionGuidesTest extends BaseStepDef {
    ...
    @Then("^the user should be presented with a list of questions including \"([^\"]*)\"$")
    ...
    @And("^the user selects checkboxes for the questions \"([^\"]*)\" and \"([^\"]*)\"$")
    ...
    @Then("^the user should be presented with a list of jurisdictions including \"([^\"]*)\"$")
    ...
    @And("^the user selects the jurisdictions \"([^\"]*)\" and \"([^\"]*)\"$")
    ...
    @Then("^the user should be presented with a comparison report which includes information based on the users selected topic the questions \"([^\"]*)\" and \"([^\"]*)\" and the jurisdictions \"([^\"]*)\" and \"([^\"]*)\"$")
    ...
    @And("^the user should be able to select the jurisdiction \"([^\"]*)\" to view$")
    ...
    @Then("^the user should be able to scroll through the selected questions \"([^\"]*)\" and \"([^\"]*)\"$")
