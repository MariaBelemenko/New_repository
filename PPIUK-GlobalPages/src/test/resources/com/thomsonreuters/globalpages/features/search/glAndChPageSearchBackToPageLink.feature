Feature: [838717][839947] As a PL+ User, I want to link back to the global page I performed a search from

  Background:
    Given PL+ user is not logged in
    And the user navigates to the main PLCUK page

  Scenario Outline: [838717][839947] Verify link back to category page
  ...
  Scenario Outline: [838717] Verify Back to country link is displayed on country search results page
