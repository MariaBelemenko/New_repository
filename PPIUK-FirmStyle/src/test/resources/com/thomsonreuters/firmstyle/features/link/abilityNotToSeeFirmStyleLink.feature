Feature: [774402] FS1 As a PL+ User I want to view the download in FirmStyle option So that I know I can download the standard document in my Company's Firm Style
