Feature: [752716] Not logged in user cannot read or create annotations

  Scenario: [752716] As a Not logged in user I want to not be able to read and create annotations so I can not use this feature.
