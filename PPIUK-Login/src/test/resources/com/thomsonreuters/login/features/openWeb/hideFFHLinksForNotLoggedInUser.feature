Feature: [752713] Not logged in user cannot see any FFH links

  Scenario: [752713] As a not logged in user I do not want to see any related links to Favourites Folders and/or History so I do not get confused when I am not able to use them.
