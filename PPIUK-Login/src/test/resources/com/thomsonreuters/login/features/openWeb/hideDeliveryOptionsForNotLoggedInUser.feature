Feature: Not logged in user cannot use delivery options

  Scenario: As a Not logged in user I want to not be able to to use delivery options on document page
  ...
  Scenario: As a Not logged in user I want to not be able to to use delivery options on search page
    Given PL+ user is not logged in
  ...
  Scenario: As a Not logged in user I want to not be able to to use delivery options on legal updates results page
    Given PL+ user is not logged in
