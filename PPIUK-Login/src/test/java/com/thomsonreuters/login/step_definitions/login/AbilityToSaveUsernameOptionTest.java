...
public class AbilityToSaveUsernameOptionTest extends BaseStepDef {
    ...
    public void heWillSeeTheUsernameBoxInTheLogInPagePopulatedWithHisUsername() throws Throwable {
        assertTrue("Username field is not correct", onePassLogin.getTextFromInputOrTextarea(onePassLogin.usernameTextField())
                .equals(onePassLoginUtils.getUserName()));
    }
