...
Feature: [755567]Form Submission into Ask Mediator
  ...
  Scenario Outline: Successful ASK form submission by PL+ user into ASK mediator from a document
    ...
    Examples:
      ...
      | Iryna     | Smoli    | Public Sector    | Legal Advisor | UK           | Arbitration      | If8523e9b93f811e598dc8b09b4f043e0 | /Document/If8523e9b93f811e598dc8b09b4f043e0/View/FullText.html |
  ...
  # 834854 [REGRESSION] Ask question with organization type "Other" and position "Other (with Free Text Box)" has empty position in Sharepoint
  @bug @CloseAskWindow
