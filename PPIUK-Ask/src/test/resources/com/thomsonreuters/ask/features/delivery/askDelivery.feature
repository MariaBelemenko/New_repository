@wip @bug
Feature: Ask Widget to download/email/print query-
  As a User
  I want to save/send query
  So that I can have a copy of the query to see offline

  # 822609 REGRESSION - Ask documents inaccessible
  # 797968 MUST: (RTL Bug):Ask -Folders: Ask resource type and ask question title NOT shown correctly when saved to folder
  Background:
  ...
  Examples:
    ...
    | I0afac67b78a211e598dc8b09b4f043e0 | Can you surrender an AHA 1986 tenancy | tr-anz-tester1@yandex.com |
  ...
  Examples:
    | guid                              | subject                                         | mailbox                   |
    | I17699cb5741511e598dc8b09b4f043e0 | Do overage rights have a value for IHT purposes | tr-anz-tester1@yandex.com |
  ...
  Examples:
    | guid                              | subject                                                                          | mailbox                   |
    | I389320b81c6811e598db8b09b4f043e0 | Distributions should directors have regard to performance subsequent to the last | tr-anz-tester1@yandex.com |
  ...
  Examples:
    | guid                              |
    | I389320b81c6811e598db8b09b4f043e0 |
