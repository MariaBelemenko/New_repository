...
@CucumberOptions(
        plugin = {"pretty", "html:target/cucumber-htmlreport/CPETCategoryPageReport", "junit:target/junit_cucumber.xml", "json:target/json-files/RunPageCreationCategoryPageTest.json"},
