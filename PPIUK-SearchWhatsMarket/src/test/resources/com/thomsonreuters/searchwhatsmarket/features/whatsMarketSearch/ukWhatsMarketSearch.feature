Feature: ukWhatsMarketSearch.feature - [702213][702225][731586][702218][702219]
  ...
  Scenario:[731586] Verify that the clear all link clears all selected whats market facets
    ...
    Then the user verifies that the whats market facet "Secondary issues" is selected
    ...
    Then the user verifies that the whats market facet "Secondary issues" is not selected
